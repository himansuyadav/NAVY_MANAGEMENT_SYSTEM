...
<body>
  ...
  <div class="main">
    ...
    <h2 align="center">OPERATION EQUIPMENT</h2>

    <div class="container"> 
       

        <div class="title">
             operation equipment detail
        </div>
        ...
        <div class="form">
          ...
          <input type="text" class="input" name="equipment_id">
            ...
            <div class="input_field">
                <lable>working status</lable>
          <input type="text" class="input" name="working_status">
            </div>
...
if($_POST['register'])
{
    ...
    $name=$_POST['equipment_id'];
    $yoj=$_POST['working_status'];
   
    $query="INSERT INTO operation_equipment VALUES('$sid','$name','$yoj')";
